...
## Funcionamento
Depois de carregar as imagens no programa, é aplicado um filtro que realça as rugas da pessoa na foto (para melhorar a predição do modelo) e depois as imagens são transformadas em matrizes e linearizadas.
...
utilizar o modelo treinado para prever em qual categoria uma nova imagem fornecida se encaixa.
